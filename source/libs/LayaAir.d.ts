...
此类用来管理XRCamera
	...
	class WebXRExperienceHelper  {
		 ...
		 * @returns 
		 */
		static supportXR(sessionMode:string):any;
		 ...
		 */
		static enterXRAsync(sessionMode:string,referenceSpaceType:string,cameraInfo:WebXRCameraInfo):any;
...
类用来创建WebXRRenderTexture
	...
	class WebXRSessionManager extends EventDispatcher  {
		 ...
		 * @returns 
		 */
		initializeXRGL(xrSession:any,gl:WebGLRenderingContext):any;
		 ...
		 */
		isSessionSupportedAsync(sessionMode:string):any;
		 ...
		 * @returns 
		 */
		initializeSessionAsync(xrSessionMode?:string,xrSessionInit?:{}):any;
		 ...
		 */
		setReferenceSpaceTypeAsync(referenceSpaceType?:string):any;
		 ...
		 */
		updateTargetFrameRate(rate:number):any;
		destroy():void;
	}
